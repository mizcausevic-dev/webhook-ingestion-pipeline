...
### Released
- Released **webhook-ingestion-pipeline** publicly as a reviewable operating system for enterprise software operations.
...
### Shipped
- Cut the first coherent internal version of **webhook-ingestion-pipeline** with stable domain objects, review surfaces, and decision outputs.
